...
class StudentIO
{
    ...
    public:
        ...
        StudentIO(string iFileName, string oFileName);
                 ...
                 *
                 * @param sId - The student Id of a student
        ...
        void GetLowestMarkOutput(const long sId, map<long, Student> & students, BinaryTree<Unit> & units) const;
                 ...
                 *
                 * @param sId - The student Id of the a student
                 * @param students - A map of Student objects
                 * @param units - A binary tree of Unit objects
                 * @return void
                 */
        ...
        void GetHighestLowest(map<long, Student> & students, BinaryTree<Unit> & units);
                ...
                /**
                 * @brief Gets the GPA of a student for a particular year
                 *
                 * Outputs the details of a students GPA for a particular year
                 *
                 * @param studentId - A student ID of a student to get the GPA of a year for
                 * @param students - A map of Student Objects
                 * @param units - A binary tree of Unit objects
                 * @param year - An unsigned integer that is the year to get the GPA for
                 * @return void
                 */
        void GetYearGPA(const long studentId, const unsigned year, map<long, Student> & students, BinaryTree<Unit> & units) const;
